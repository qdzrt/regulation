...
(function() {
  $(function() {
    ...
    $("input[name='active-checkbox']").on('switchChange.bootstrapSwitch', function(event, state) {
      console.log(event);
      return console.log(state);
    });
    return $('.seckill').click(function(e) {
      return $.ajax({
        url: 'loan_fees/seckill',
        method: 'get',
        data: {
          loan_fee_id: $(this).data('target')
        },
...
(function() {
  $(function() {
    return $('.img-del').click(function(e) {
      return $.ajax({
        type: 'DELETE',
